      ...
      'v-pagination': __vue_component__,
		...
		methods: {
			...
			fetch: function(){
				...
				this.index(this, { query: this.filter, onSuccess: function (ref) {
					var data = ref.data;
